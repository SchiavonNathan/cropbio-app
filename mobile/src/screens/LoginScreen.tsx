    ...
    >
      <View style={styles.card}>
        <View style={styles.logoWrapper}>
          <Image source={require('../../assets/cropbio.png')} style={styles.logo} resizeMode="contain" />
        </View>
        <Text style={styles.title}>CropBio</Text>
        <Text style={styles.subtitle}>Acesso aos Documentos & Tabelas</Text>
