...
export class CategoriesController {
    ...
    FileInterceptor('image', {
      ...
      storage: diskStorage({
        ...
        filename: (req, file, cb) => {
          // name is like "Produtos e tabelas"
  ...
  async uploadImage(
    ...
    // Cleanup old files with different extensions for the same category
  ...
  // Find image dynamically by category name without knowing extension
  @Get('find-image/:name')
